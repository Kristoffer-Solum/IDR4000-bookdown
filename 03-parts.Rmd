...
Totalt, førte 12 uker med styrketrening til en signifikant økning i muskelstyrke mellom gruppene på 31±14% for multiple- sett og en økning på 25±13% for multiple- sett (P\<0,001). Økningen i muskelvekst var også signifikant på 3,3±4% for multiple- sett og 2±4% for single- sett (P\<0,001).
