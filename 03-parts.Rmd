...
```{r Prosentvis økning figur dexa, echo=FALSE, message=FALSE, warning=FALSE, include=TRUE, results="hide", out.width="120%", fig.cap = "Figuren viser prosentvis økning i muskelvekst mellom multiple- sett og singe- sett ved posttest etter 12 uker med styrketrening"}
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, include=TRUE, results="hide", out.width="120%", fig.cap= "Figuren viser økning i muskelstyrke mellom multiple- sett og singe- sett ved pretest og posttest etter 12 uker med styrketrening (diff= -0.029AU)"}
strengthvolume %>%
...
```{r Prosentvis økning figur styrke, echo=FALSE, message=FALSE, warning=FALSE, include=TRUE, results="hide", out.width="120%", fig.cap= "Figuren viser prosentvis økning i muskelstyrke mellom multiple- sett og singe- sett ved posttest etter 12 uker med styrketrening"} 
